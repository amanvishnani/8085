...
public class Main extends javax.swing.JFrame implements IView {
        ...
        int parseHex(String s, int defaultVal, int min, int max, String label) {
                return MainHelper.parseHex(s, defaultVal, min, max, label,
                                msg -> JOptionPane.showMessageDialog(this, "{" + msg + "}"));
        }
        ...
        private void initComponents() {
                ...
                jPanel3Layout.setHorizontalGroup(
                                jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                                .addComponent(jScrollPane5, javax.swing.GroupLayout.DEFAULT_SIZE, 425,
                                                                Short.MAX_VALUE)
